...
require_once 'MaintenanceXmlRpcService.php';
...
class XmlRpcFrontController
{
    ...
    // Maintenance Functions
     public function runMaintenance($message)
    {
        $service = new MaintenanceXmlRpcService();
        return $service->runMaintenance($message);
    }
